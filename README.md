# hmpps-datahub-query-metrics

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-datahub-query-metrics/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-datahub-query-metrics)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-datahub-query-metrics)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://datahub-query-metrics-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-datahub-query-metrics/security/policy).
...
## Renaming from HMPPS Datahub Query Metrics - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-datahub-query-metrics=0
```
